...
Zdroj je vše, na čem [komponenta](#Component) závisí. Zdroj musí být na základě potřeb komponenty zpřístupněn a udržován. Mezi zdroje patří například čas CPU, operační pamět, místo na disku, nebo propustnost sítě, plánovač služeb a další vstupní a výstupní služby jako databáze, systém souborů atd. Pokud není [pružnost](#Elasticity) a odolnost těchto zdrojů zajištěna, může dojít k nesprávnému fungování požadované komponenty.
